# https://github.com/ofborg/ofborg-infrastructure/blob/b343d39e87ab26f8085b5ef85aab9be7e8db4a34/macs/module/hydra-queue-builder.nix
{
  config,
  pkgs,
  lib,
...
let
  cfg = config.nixCommunity.hydra-queue-builder-v2;

...
```
aarch64-build-box.nix-community.org ssh-ed25519 ?
```

`aarch64-darwin`, `x86_64-darwin`

```
darwin-build-box.nix-community.org ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDZw+Zk6dKiiXVx2Zlo67b6uQ3o+BhPn9UU9BC6SIgZ4
```
